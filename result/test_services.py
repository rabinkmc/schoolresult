...
from result.services import load_teachers, \
    load_subjects,load_students,read_csv
...
class ServicesTestCase(TestCase):
    ...
    def test_models_are_loaded(self):
        ...
        self.assertEqual(Subject.objects.all().count(),
                len(subjects))
        ...
        self.assertEqual(Student.objects.all().count(),
                len(students))
